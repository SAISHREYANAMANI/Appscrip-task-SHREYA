...
import { Recommended, filters } from "@/Assests/Assests";
import Spinner from "../Filters/Spinner";
import Image from "next/image";
import { png } from "@/Assests/Assests"
                            ...
                            <ul>
                                {Recommended.map((link, index) => (
                                    <li style={{ fontWeight: index === 0 ? 'bold' : 'normal' }} key={index}>
                                      {index === 0 && <div style={{display:"inline-block",padding:"5px"}}><Image src={png?.vector} alt="vector" /></div>}
                                      {link.title} 
                                    </li>
                                ))}
                            </ul>
